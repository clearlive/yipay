...
function allClick(){
  ...
  $("#channelPanel").mouseleave(function(){
    ...
    $("#gridShowContent").html('现在支付聚合平台，全渠道支付方式、高效对接、简洁而强大的交易账务管理，专业为你服务。')
    $(".first-contet-btn-div").css({
      'display':'block'
    })
  ...
  $(".menu-mch").click(function(){
    window.open("/");
  });
  $(".menu-help").click(function(){
    window.open("/cha");
  });
  $(".moreMch").click(function(){
    window.open("/");
  })
  $(".shzx").click(function(){
    window.open("/user");
  ...
  $(".mbApp").click(function(){
    window.open("#");
  });

  $(".wapPay").click(function(){
    window.open("#");
  });
  $(".mbWapPay").click(function(){
    window.open("#");
  });
  $(".posPay").click(function(){
    window.open("#");
  });
  $(".cNitiative").click(function(){
    window.open("#");
  });

  $(".bPassivity").click(function(){
    window.open("#");
  });
  ...
  $(".sixth-help-ul").find("li").find("span").click(function(){
    window.open("/help");
  })
  $(".forth-content-right").click(function(){
    window.open("#");
  })
  $(".forth-content-left").click(function(){
    window.open("#");
  })

  $("#second-block_1").click(function(){
    window.open("#")
  })
  $("#second-block_2").click(function(){
    window.open("#")
  })
  $("#second-block_3").click(function(){
    window.open("#")
  })
...
function mchFloatWindow(){
  ...
  $.each($("#pagination1").children(), function () {
    ...
    if ( ($(this).attr("class").toString()).indexOf(tag) > 0 ) {
      ...
      if($(this).index() != 5){
        $(".mchGlass-logo").css({
          'background': 'url(/static/images/mch-img/mchlogo'+$(this).index()+'-cg.png) no-repeat center',
      ...
      if($(this).index() == 0){
        $(this).css({
          'background':'url(/static/images/mch-img/mch-index/mchlogo'+$(this).index()+'-cg.png) no-repeat center, linear-gradient(134deg, #61D0FF 0%, #0055FF 100%)',
        });
      }else if($(this).index() == 1){
        $(this).css({
          'background':'url(/static/images/mch-img/mch-index/mchlogo'+$(this).index()+'-cg.png) no-repeat center, linear-gradient(134deg, #7DDFFF 0%, #00BEFF 100%)',
        });
      }else if($(this).index() == 2){
        $(this).css({
          'background':'url(/static/images/mch-img/mch-index/mchlogo'+$(this).index()+'-cg.png) no-repeat center, linear-gradient(134deg, #1FC891 0%, #1BFD6C 100%)',
        });
      }else if($(this).index() == 3){
        $(this).css({
          'background':'url(/static/images/mch-img/mch-index/mchlogo'+$(this).index()+'-cg.png) no-repeat center, linear-gradient(134deg, #FF7D8C 0%, #FF1033 100%)',
        });
      }else if($(this).index() == 4){
        $(this).css({
          'background':'url(/static/images/mch-img/mch-index/mchlogo'+$(this).index()+'-cg.png) no-repeat center, linear-gradient(134deg, #6DD1FF 0%, #0032FF 100%)',
        });
      }else{
        return;
      }
      ...
      if($(this).index() != 5){
        $(this).css({
          'background':'url(/static/images/mch-img/mch-index/mchlogo'+$(this).index()+'.png) no-repeat center',
        })
      }
    }
