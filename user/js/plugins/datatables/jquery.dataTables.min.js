...
fnStateLoaded:null,fnStateSaveCallback:function(a,b){try{(-1===a.iStateDuration?sessionStorage:localStorage).setItem("DataTables_"+a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": 降序排序",sSortDescending:": 升序排序"},oPaginate:{sFirst:"首页",sLast:"最后一页",sNext:"下一页",sPrevious:"上一页"},
sEmptyTable:"暂无数据",sInfo:"当前显示 _START_ 至 _END_ 条 | 共 _TOTAL_ 条数据",sInfoEmpty:"0 条数据",sInfoFiltered:"(在 _MAX_ 条数据中查找)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"每页显示 _MENU_ 条数据",sLoadingRecords:"请稍后...",sProcessing:"处理...",sSearch:"搜索订单:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"无匹配条件记录"},oSearch:h.extend({},p.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",sPaginationType:"simple_numbers",
